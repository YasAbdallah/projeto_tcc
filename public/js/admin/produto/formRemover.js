...
export function construirModalRemoverProduto(id, produto) {
    const modalContainer = criarTag("div", {
        class: "modal fade",
        id: `modalRemover${id}`,
        tabindex: "-1",
        "aria-labelledby": `modalRemover_${id}Label`,
        "aria-hidden": "true"
    });
    ...
    const modalTitle = criarTag("h1", {
        ...
        id: `modalRemover_${id}Label`
    }, `Você está prestes a remover o produto "${produto}" da lista`);
    ...
    const modalBody = criarTag("div", {
        class: "modal-body"
    }, "Ao proceder com esta ação, o produto será removido de forma permanente da lista de produtos do sistema. Esta operação é irreversível e, ao confirmá-la, você assume total responsabilidade por sua execução e seus efeitos.");
