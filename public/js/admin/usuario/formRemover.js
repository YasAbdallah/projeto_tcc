...
export function construirModalRemoverUsuario(id, nome) {
    ...
    }, `Você está prestes a remover o usuário ${nome} da lista`);
    ...
    const modalBody = criarTag("div", {
        class: "modal-body"
    }, "Ao proceder com esta ação, o usuário será removido de forma permanente da lista de usuários do sistema. Esta operação é irreversível e, ao confirmá-la, você assume total responsabilidade por sua execução e seus efeitos.");
